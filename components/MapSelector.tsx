...
import { reverseGeocode, fetchHaloRadius } from './map/mapUtils';
...
const MapSelector: React.FC<MapSelectorProps> = ({
  ...
  return (
    <div className="relative w-full h-full rounded-lg overflow-hidden">
      {address && (
        <p className="absolute top-2 left-2 z-10 bg-white/75 dark:bg-gray-800/75 px-3 py-1.5 text-sm rounded-md shadow-sm max-w-[80%] truncate">
          {address}
        </p>
      )}
